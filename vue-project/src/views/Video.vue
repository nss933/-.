...
export default {
  ...
  methods:{
    active(){
     ...
     actives(){
      this.img1=require('@/assets/video/6.png')
     ...
     activesTwo(){
      this.img2=require('@/assets/video/6.png')
    ...
    activeThree(){
     ...
     activesThree(){
      this.img3=require('@/assets/video/6.png')
     
    },
    videoOne(){
      open('https://cdn.djivideos.com/watch/d6e9d162-81cb-4623-add4-63c3d4e4e3d5?autoplay=false&poster=')
    },
    videoTwo(){
      open('//cdn.djivideos.com/watch/0e9a05fb-0a30-4e20-bb4b-4dd70f3f54c2?autoplay=false&poster=https://videocaption.djicdn.com/poster/20220509/adc9585b90432096f6a230ebeae26509.png@!1200')
    },
    videoThree(){
      open('//cdn.djivideos.com/watch/4aeb6351-7b0c-436c-b165-1a00cdcf768f?autoplay=false&poster=https://videocaption.djicdn.com/poster/20220509/7934125125f0fb446435968eece52f22.png@!1200')
    },
  },
};
</script>
